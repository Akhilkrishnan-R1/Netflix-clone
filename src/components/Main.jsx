      ...
      <div className='w-full h-full'>
        ...
        <img className='w-full h-full object-cover' src={`https://image.tmdb.org/t/p/original/${movie?.backdrop_path}`}
         ...
         <div className='absolute w-full top-[20%] p-4 md:p-8  '>
          ...
          <div className='my-4'>
            <button className='border bg-gray-300 text-black border-gray-300 py-2 px-2'>Play</button>
            <button className='border text-white ml-4 border-gray-300 py-2 px-2'>Watch Later</button>
          </div>
